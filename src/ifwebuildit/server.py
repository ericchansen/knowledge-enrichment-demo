...
from ifwebuildit.config import get_settings
from ifwebuildit.models import (
    ChatRequest,
    ChatResponse,
    CorpusInfo,
    Document,
...
from ifwebuildit.services.chat import ChatService
from ifwebuildit.services.content_understanding import ContentUnderstandingService
    ...
    async def run_pipeline(request: PipelineRequest) -> PipelineStatus:
        ...
        try:
            ...
            if request.pipeline_type == PipelineType.BASELINE:
                ...
                from ifwebuildit.pipeline.enhanced import EnhancedPipeline
