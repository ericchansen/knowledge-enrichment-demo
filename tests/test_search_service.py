...
from ifwebuildit.services.search import (
...
def search_service():
    ...
    with patch(
        "ifwebuildit.services.search.SearchIndexClient"
...
def test_index_chunks(search_service):
    ...
    with patch("ifwebuildit.services.search.SearchClient") as mock_search_cls:
