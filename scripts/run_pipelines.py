...
from ifwebuildit.config import get_settings  # noqa: E402
from ifwebuildit.pipeline.baseline import BaselinePipeline  # noqa: E402
from ifwebuildit.pipeline.enhanced import EnhancedPipeline  # noqa: E402
from ifwebuildit.services.content_understanding import (  # noqa: E402
    ContentUnderstandingService,
)
from ifwebuildit.services.embedding import EmbeddingService  # noqa: E402
from ifwebuildit.services.search import SearchService  # noqa: E402
from ifwebuildit.services.storage import StorageService  # noqa: E402
...
def main() -> None:
    ...
    logger.info("Start the server: uv run uvicorn ifwebuildit.server:app --reload")
